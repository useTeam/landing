...
The Sanity Studio will be available at `http://localhost:3333` and your application at `http://localhost:3000`.

### Accessing the Blog:
- Admin interface (Sanity Studio): `http://localhost:3000/studio`
